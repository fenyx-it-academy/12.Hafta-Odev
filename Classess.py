"""# 12.Hafta-Odev #
Tasit isimli bir sinif tanimlayiniz. bir Araba sinifi tanimlayiniz ve bu sinifi, Tasit sinifindan miras aliniz.
"""
...
class Araba(Tasit):
    ...
    def __init__(self,motor_gucu,koltuk_sayisi,km_durumu,modeli,satis_yili,max_hiz,arabanin_modeli,hiz = 0):
        super().__init__(motor_gucu,koltuk_sayisi,km_durumu,modeli,satis_yili)
        self.max_hiz=max_hiz
        self.arabanin_modeli=arabanin_modeli
        self.hiz = hiz
    ...
    def modelini_goster(self):
        print("Araba sinifinin modeli:",self.arabanin_modeli)
    def arabanin_durumunu_goster(self):
        print("""
        Arabanin Su Anki Durumu:
        1) Motor Gucu       :{}
        2) Koltuk sayisi    :{}
        3) KM durumu        :{}
        4) Modeli           :{}
        ...
        6) Teker Sayisi     :{}
        7) Maximum Hiz      :{}       
        """.format(self.motor_gucu,self.koltuk_sayisi,self.km_durumu,self.arabanin_modeli,self.satis_yili,self.tekerlek_sayisi,self.max_hiz))

arabaaa=Araba(120,5,171000,2011,2012,190,2000)
print("Araba sinifina ait arabanin modeli",arabaaa.arabanin_modeli)
...
while True:
    ...
    if giris=="1":
        ...
        Tasit.tasit_miktarini_guncelle(tasit_adi)
        print(araba1._Tasit__tasit_miktari)
    elif giris=="4":
